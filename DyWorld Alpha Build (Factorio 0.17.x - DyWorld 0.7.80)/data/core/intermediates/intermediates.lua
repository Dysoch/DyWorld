...
local Data_Table = {
	...
	},
	{
		...
		Recipe_Category = dy.."compressor",
		Recipe_Result_Count = 1,
		Recipe_Ingredients = {{dy.."sand", 250},{dy.."obsidian", 25},{"coal", 2}},
		Tech_Name = "advanced-electronics-2",
	},
	{
		Name = "crystai",
		...
		Recipe_Category = dy.."compressor",
		Recipe_Result_Count = 1,
		Recipe_Ingredients = {{dy.."sand", 50},{dy.."crystal", 2}},
		Tech_Name = "advanced-electronics-2",
	},
	{
		Name = "obsidian",
	...
	},
	{
		...
		Recipe_Craft_Time = 2.5,
		Recipe_Result_Count = 1,
		Recipe_Ingredients = {{"copper-plate", 1},{"chalcopyrite", 3}},
	},
	{
		...
		Recipe_Craft_Time = 2.5,
		Recipe_Result_Count = 1,
		Recipe_Ingredients = {{"iron-plate", 1},{"hematite", 5}},
	},
	{
		Name = "filter-empty",
