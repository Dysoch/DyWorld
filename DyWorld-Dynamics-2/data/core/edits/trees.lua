...
for k,v in pairs(data.raw.tree) do
	if v.minable then
		if v.minable.results then
			v.minable.results = {
				{type = "item", name = "log", amount_min = 2, amount_max = 8, probability = 0.8},
				{type = "item", name = "log-sulfur", amount_min = 1, amount_max = 5, probability = 0.1},
				{type = "item", name = "log-dead", amount_min = 1, amount_max = 5, probability = 0.05},
				{type = "item", name = "bark", amount_min = 1, amount_max = 30, probability = 0.075},
				{type = "item", name = "sap", amount_min = 1, amount_max = 10, probability = 0.035},
				{type = "item", name = "sapling-normal", amount_min = 1, amount_max = 5, probability = 0.15},
				{type = "item", name = "sapling-sulfur", amount_min = 1, amount_max = 2, probability = 0.05},
			}
	...
	v.loot = {
		{item = "log", amount_min = 2, amount_max = 8, probability = 0.8},
		{item = "log-sulfur", amount_min = 1, amount_max = 5, probability = 0.1},
		{item = "log-dead", amount_min = 1, amount_max = 5, probability = 0.05},
		{item = "bark", amount_min = 1, amount_max = 30, probability = 0.075},
		{item = "sap", amount_min = 1, amount_max = 10, probability = 0.035},
		{item = "sapling-normal", amount_min = 1, amount_max = 5, probability = 0.15},
		{item = "sapling-sulfur", amount_min = 1, amount_max = 2, probability = 0.05},
	}
