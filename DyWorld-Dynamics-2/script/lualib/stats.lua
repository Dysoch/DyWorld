...
function Codia_Calc(id, armor, lvl)
    ...
    global.dyworld.players[id].stats.codai_level.total = math.floor(global.dyworld.players[id].stats.codai_level.armor + global.dyworld.players[id].stats.codai_level.dis)
