...
require(DyDs_data_core.. "recipes.cables")
	...
	require(DyDs_data_core.. "recipes.plates.blast-furnace.aluminium")
	require(DyDs_data_core.. "recipes.plates.blast-furnace.bronze")
	require(DyDs_data_core.. "recipes.plates.blast-furnace.copper")
	require(DyDs_data_core.. "recipes.plates.blast-furnace.iron")
	require(DyDs_data_core.. "recipes.plates.blast-furnace.magnesium")
	require(DyDs_data_core.. "recipes.plates.blast-furnace.steel")
	require(DyDs_data_core.. "recipes.plates.blast-furnace.tin")
	require(DyDs_data_core.. "recipes.plates.blast-furnace.titanium")
	
	require(DyDs_data_core.. "recipes.plates.caster.aluminium")
	require(DyDs_data_core.. "recipes.plates.caster.bronze")
	require(DyDs_data_core.. "recipes.plates.caster.copper")
	require(DyDs_data_core.. "recipes.plates.caster.iron")
	require(DyDs_data_core.. "recipes.plates.caster.magnesium")
	require(DyDs_data_core.. "recipes.plates.caster.steel")
	require(DyDs_data_core.. "recipes.plates.caster.tin")
	require(DyDs_data_core.. "recipes.plates.caster.titanium")
