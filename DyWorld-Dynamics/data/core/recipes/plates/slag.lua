...
data:extend({
  ...
  },
  {
    ...
    normal =
    {
      ingredients =
      {
        {type = "item", name = "slag", amount = 50},
        {type = "item", name = "lignite", amount = 25},
      },
      results = 
      {
        {type = "item", name = "slag", amount_min = 0, amount_max = 10, probability = 0.1},
        {type = "item", name = "iron-ore-impure", amount_min = 0, amount_max = 11, probability = 0.15},
        {type = "item", name = "iron-ore", amount_min = 0, amount_max = 8, probability = 0.075},
        {type = "item", name = "tin-ore-impure", amount_min = 0, amount_max = 11, probability = 0.15},
        {type = "item", name = "tin-ore", amount_min = 0, amount_max = 8, probability = 0.075},
        {type = "item", name = "copper-ore-impure", amount_min = 0, amount_max = 11, probability = 0.15},
        {type = "item", name = "copper-ore", amount_min = 0, amount_max = 8, probability = 0.075},
        {type = "item", name = "titanium-ore-impure", amount_min = 0, amount_max = 11, probability = 0.15},
        {type = "item", name = "titanium-ore", amount_min = 0, amount_max = 8, probability = 0.075},
        {type = "item", name = "magnesium-ore-impure", amount_min = 0, amount_max = 11, probability = 0.15},
        {type = "item", name = "magnesium-ore", amount_min = 0, amount_max = 8, probability = 0.075},
        {type = "item", name = "aluminium-ore-impure", amount_min = 0, amount_max = 11, probability = 0.15},
        {type = "item", name = "aluminium-ore", amount_min = 0, amount_max = 8, probability = 0.075},
        {type = "item", name = "coal", amount_min = 0, amount_max = 10, probability = 0.15},
        {type = "item", name = "lignite", amount_min = 0, amount_max = 15, probability = 0.25},
        {type = "item", name = "limestone", amount_min = 0, amount_max = 15, probability = 0.05},
        {type = "item", name = "granite", amount_min = 0, amount_max = 15, probability = 0.05},
        {type = "item", name = "sandstone", amount_min = 0, amount_max = 15, probability = 0.05},
        {type = "item", name = "quartzite", amount_min = 0, amount_max = 15, probability = 0.05},
      },
	  energy_required = 12,
	  main_product = "slag",
	  enabled = false,
