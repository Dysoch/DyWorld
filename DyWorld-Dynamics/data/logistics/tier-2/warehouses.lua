...
data:extend({
	{
		...
		icon = DyDs_path_icon.."warehouse-basic.png",
		icon_size = 64,
		...
		picture =
		{
			filename = DyDs_path_entity.."warehouse-basic.png",
			priority = "high",
			width = 260,
			height = 240,
			shift = {1.0, -0.3},
...
data:extend({
	...
	warehouse_requester,
	{
		...
		icon = DyDs_path_icon.."warehouse-basic.png",
		icon_size = 64,
		subgroup = DyDs.."chests-warehouse",
	...
	},
	{
		...
		icon = DyDs_path_icon.."warehouse-passive-provider.png",
		icon_size = 64,
		subgroup = DyDs.."chests-warehouse",
	...
	},
	{
		...
		icon = DyDs_path_icon.."warehouse-active-provider.png",
		icon_size = 64,
		subgroup = DyDs.."chests-warehouse",
	...
	},
	{
		...
		icon = DyDs_path_icon.."warehouse-buffer.png",
		icon_size = 64,
		subgroup = DyDs.."chests-warehouse",
	...
	},
	{
		...
		icon = DyDs_path_icon.."warehouse-requester.png",
		icon_size = 64,
		subgroup = DyDs.."chests-warehouse",
	...
	},
	{
		...
		icon = DyDs_path_icon.."warehouse-storage.png",
		icon_size = 64,
		subgroup = DyDs.."chests-warehouse",
