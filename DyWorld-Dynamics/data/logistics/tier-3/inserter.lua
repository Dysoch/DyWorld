...
data:extend({
  ...
  },
  {
    ...
    icon_size = 64,
    subgroup = DyDs.."inserter-long-filter",
    order = "3",
  ...
  },
  {
    ...
    icon_size = 64,
    subgroup = DyDs.."inserter-far-filter",
    order = "3",
