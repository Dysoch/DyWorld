...
local DyWorld_Prototype_1 = DyDs_CopyPrototype("loader-1x1", "loader-1x1", "loader-3", true)
DyWorld_Prototype_1.minable = {mining_time = 0.5, result = "loader-3"}
...
DyWorld_Prototype_1.next_upgrade = "loader-4"
  ...
  },
  {
    ...
    normal =
    {
      ingredients =
      {
        ...
        {type = "item", name = "transport-belt-3", amount = 1},
      },
      result = "loader-3",
	  result_count = 1,
	  energy_required = 2,
