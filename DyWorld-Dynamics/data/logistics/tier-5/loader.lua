...
local DyWorld_Prototype_1 = DyDs_CopyPrototype("loader-1x1", "loader-1x1", "loader-5", true)
DyWorld_Prototype_1.minable = {mining_time = 0.5, result = "loader-5"}
  ...
  },
  {
    ...
    normal =
    {
      ingredients =
      {
        ...
        {type = "item", name = "transport-belt-5", amount = 1},
      },
      result = "loader-5",
	  result_count = 1,
	  energy_required = 2,
