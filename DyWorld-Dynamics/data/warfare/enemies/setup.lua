...
local Tier_Tint = {
  [1] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [2] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [3] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [4] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [5] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [6] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [7] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [8] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [9] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
  [10] = {{r=0.37, g=0.40, b=0.72, a=1}, {r=0.55, g=0.76, b=0.75, a=1}},
}
