...
-------------------------------- Ore Tier 1 TAB -------------------------------------
	...
	for k,v in pairs(global.dyworld.game_stats.space_mining) do
		if (Dy_Metals[k] and Dy_Metals[k].Ore_Tier == 1) then
			...
			frameflow2.add{type = "label", caption = {"gui-stats.space-mining-caption", {"looped-name."..k}, Round((v.pure_mined + v.impure_mined), 2)}, tooltip = {"gui-stats.space-mining-tooltip", {"looped-name."..k}, Round(v.impure_mined, 2), v.impure_storage, Round(v.impure_rate, 2), Round(v.pure_mined, 2), v.pure_storage, Round(v.pure_rate, 2), Round((v.efficiency * 100), 2)}}
...
-------------------------------- Ore Tier 2 TAB -------------------------------------
	...
	for k,v in pairs(global.dyworld.game_stats.space_mining) do
		if (Dy_Metals[k] and Dy_Metals[k].Ore_Tier == 2) then
			...
			frameflow3.add{type = "label", caption = {"gui-stats.space-mining-caption", {"looped-name."..k}, Round((v.pure_mined + v.impure_mined), 2)}, tooltip = {"gui-stats.space-mining-tooltip", {"looped-name."..k}, Round(v.impure_mined, 2), v.impure_storage, Round(v.impure_rate, 2), Round(v.pure_mined, 2), v.pure_storage, Round(v.pure_rate, 2), Round((v.efficiency * 100), 2)}}
...
-------------------------------- Ore Tier 3 TAB -------------------------------------
	...
	for k,v in pairs(global.dyworld.game_stats.space_mining) do
		if (Dy_Metals[k] and Dy_Metals[k].Ore_Tier == 3) then
			...
			frameflow4.add{type = "label", caption = {"gui-stats.space-mining-caption", {"looped-name."..k}, Round((v.pure_mined + v.impure_mined), 2)}, tooltip = {"gui-stats.space-mining-tooltip", {"looped-name."..k}, Round(v.impure_mined, 2), v.impure_storage, Round(v.impure_rate, 2), Round(v.pure_mined, 2), v.pure_storage, Round(v.pure_rate, 2), Round((v.efficiency * 100), 2)}}
...
-------------------------------- Ore Tier 5 TAB -------------------------------------
	...
	for k,v in pairs(global.dyworld.game_stats.space_mining) do
		if (Dy_Metals[k] and Dy_Metals[k].Ore_Tier == 5) then
			...
			frameflow6.add{type = "label", caption = {"gui-stats.space-mining-caption", {"looped-name."..k}, Round((v.pure_mined + v.impure_mined), 2)}, tooltip = {"gui-stats.space-mining-tooltip", {"looped-name."..k}, Round(v.impure_mined, 2), v.impure_storage, Round(v.impure_rate, 2), Round(v.pure_mined, 2), v.pure_storage, Round(v.pure_rate, 2), Round((v.efficiency * 100), 2)}}
