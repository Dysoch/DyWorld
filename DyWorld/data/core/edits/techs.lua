...
local Tech_Add = {
	["automation"] = {{type = "unlock-recipe", recipe = dy.."greenhouse"}, {type = "unlock-recipe", recipe = dy.."wood-creation-1"}, {type = "unlock-recipe", recipe = dy.."water-seperation-1"}, {type = "unlock-recipe", recipe = dy.."sludge-seperation"}, {type = "unlock-recipe", recipe = "centrifuge"}, {type = "unlock-recipe", recipe = dy.."wood-seed"}},
