...
data:extend(
{
  ...
  },
  {
	...
	icon_size = 32,
    flags = {"placeable-player", "player-creation"},
    minable = {mining_time = 1, result = "lab-7"},
    max_health = 150,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
	fast_replaceable_group = "lab",
...
DyWorld_Add_To_Tech("chemical-science-pack", "lab-4")
DyWorld_Add_To_Tech("production-science-pack", "lab-5")
DyWorld_Add_To_Tech("utility-science-pack", "lab-6")
DyWorld_Add_To_Tech("space-science-pack", "lab-7")