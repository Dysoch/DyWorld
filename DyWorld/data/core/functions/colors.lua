...
Damage_Color = {
	["nuclear"] = {r=0.49, g=1, b=0.51, a=1},
	["electric"] = {r=0.49, g=0.46, b=0.9, a=1},
	["poison"] = {r=0.49, g=1, b=0.51, a=1},
	["acid"] = {r=0.49, g=1, b=0.51, a=1},
	["gas"] = {r=0.32, g=0.23, b=0.32, a=1},
	["water"] = {r=0.12, g=0.12, b=1, a=1},
	["fire"] = {r=1, g=0.12, b=0.12, a=1},
	["lightning"] = {r=0.12, g=0.12, b=0.8, a=1},
	["fungal"] = {r=0.8, g=1, b=0.51, a=1},
	["plasma"] = {r=0.12, g=0.8, b=0.8, a=1},
	["laser"] = {r=1, g=1, b=0.51, a=1},
	["lava"] = {r=1, g=0.30, b=0.30, a=1},
	["earth"] = {r=0.49, g=0.9, b=0.9, a=1},
	["fission"] = {r=0.02, g=0.02, b=0.02, a=1},
	["chemical"] = {r=0.24, g=0.42, b=0.24, a=1},
	["physical"] = {r=0.49, g=0.46, b=0.51, a=1},
	["explosion"] = {r=0.75, g=0.46, b=0.39, a=1},
	["impact"] = {r=0.49, g=0.46, b=0.51, a=1},
	["sonic"] = {r=0.7, g=0.7, b=0.7, a=1},
	["ice"] = {r=0.34, g=0.12, b=0.7, a=1},
	["fusion"] = {r=0.02, g=0.12, b=0.4, a=1},
}