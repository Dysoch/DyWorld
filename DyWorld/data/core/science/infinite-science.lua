...
data:extend(
{
  ...
  },
  {
    ...
    results=
    {
      {type = "fluid", name = dy.."science-fluid-1", amount = 50},
      {type = "fluid", name = dy.."science-fluid-2", amount = 50},
      {type = "fluid", name = dy.."science-fluid-3", amount = 50},
      {type = "fluid", name = dy.."science-fluid-4", amount = 50},
      {type = "fluid", name = dy.."science-fluid-5", amount = 50},
      {type = "fluid", name = dy.."science-fluid-6", amount = 50},
