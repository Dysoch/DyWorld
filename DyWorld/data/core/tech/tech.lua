...
local Data_Table = {
	...
	{
		Name = "automobilism-2",
		Icon = {{icon = "__base__/graphics/technology/automobilism.png"}},
		Pre_Req = {"automobilism"},
		Tech_Ingredients = 2,
		Count = 250,
		Military = true,
	},
	...
	{
		Name = "tanks-2",
		Icon = {{icon = "__base__/graphics/technology/tanks.png"}},
		Pre_Req = {"tanks"},
		Tech_Ingredients = 4,
		Count = 250,
		Military = true,
