...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Pumpjack then	
	...
	DyWorld_Prototype_Entity.resource_searching_radius = ((v.DyWorld.Entity.Pumpjack.Pumpjack_Range / 2) - 0.01)
	DyWorld_Prototype_Entity.next_upgrade = v.DyWorld.Entity.Pumpjack.Pumpjack_Next.."-pumpjack"
	DyWorld_Prototype_Entity.mining_speed = v.DyWorld.Entity.Pumpjack.Pumpjack_Speed
	DyWorld_Prototype_Entity.energy_usage = Round((v.DyWorld.Entity.Pumpjack.Pumpjack_Speed * 180), 0).."kW"
	...
	if v.DyWorld.Entity.Pumpjack.Pumpjack_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Pumpjack.Pumpjack_Ingredients) do
	...
	if v.DyWorld.Entity.Pumpjack.Pumpjack_Previous then
		local Ingredient = {type = "item", name = v.DyWorld.Entity.Pumpjack.Pumpjack_Previous.."-pumpjack", amount = 1}
		table.insert(data.raw.recipe[v.DyWorld.Name.."-pumpjack"].normal.ingredients, Ingredient)
