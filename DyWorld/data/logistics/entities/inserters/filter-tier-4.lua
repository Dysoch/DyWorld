...
data:extend(
{
  {
    type = "inserter",
    name = "filter-inserter-tier-"..STACK_TIER,
	localised_name = {"looped-name.inserter-5", STACK_TIER},
    icon = "__base__/graphics/icons/filter-inserter.png",
    icon_size = 32,
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = { mining_time = 0.1, result = "filter-inserter-tier-"..STACK_TIER },
    max_health = 160,
  ...
  },
  {
    ...
    order = "3",
    place_result = "filter-inserter-tier-"..STACK_TIER,
    stack_size = 200
  },
  {
    type = "recipe",
    ...
    enabled = false,
    ingredients = {
      {"filter-inserter-tier-1", 1},
      {"advanced-control-board", 1},
      {"electrum-plate", 2}
	},
    result = "filter-inserter-tier-"..STACK_TIER
  },
}
)

DyWorld_Add_To_Tech("automation-"..TIER, "filter-inserter-tier-"..STACK_TIER)