...
data:extend(
{
  {
    type = "inserter",
    name = "stack-filter-inserter-tier-"..STACK_TIER,
	localised_name = {"looped-name.inserter-6", STACK_TIER},
    icon = "__base__/graphics/icons/stack-filter-inserter.png",
    icon_size = 32,
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = { mining_time = 0.1, result = "stack-filter-inserter-tier-"..STACK_TIER },
    max_health = 160,
  ...
  },
  {
    ...
    order = "3",
    place_result = "stack-filter-inserter-tier-"..STACK_TIER,
    stack_size = 200
  },
  {
    type = "recipe",
    ...
    enabled = false,
    ingredients = {
      {"stack-filter-inserter-tier-1", 1},
      {"extreme-control-board", 1},
      {"neutronium-plate", 2}
	},
    result = "stack-filter-inserter-tier-"..STACK_TIER
  },
}
)
