...
data:extend(
{
  {
    type = "inserter",
    name = "stack-long-inserter-tier-"..STACK_TIER,
	localised_name = {"looped-name.inserter-4", STACK_TIER},
    icon = "__base__/graphics/icons/stack-inserter.png",
    icon_size = 32,
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = { mining_time = 0.1, result = "stack-long-inserter-tier-"..STACK_TIER },
    max_health = 160,
  ...
  },
  {
    ...
    order = "1",
    place_result = "stack-long-inserter-tier-"..STACK_TIER,
    stack_size = 200
  },
  {
    type = "recipe",
    ...
    enabled = false,
    ingredients = {
      {"stack-long-inserter-tier-4", 1},
      {"quantum-control-board", 1},
      {"neutrobaltium-plate", 5},
	},
    result = "stack-long-inserter-tier-"..STACK_TIER
  },
}
)
