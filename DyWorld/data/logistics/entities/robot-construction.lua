...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Robot then	
	...
	if v.DyWorld.Entity.Robot.Construction_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Robot.Construction_Ingredients) do
	...
	if v.DyWorld.Entity.Robot.Previous then
		local Ingredient = {type = "item", name = v.DyWorld.Entity.Robot.Previous.."-construction-robot", amount = 1}
		table.insert(data.raw.recipe[v.DyWorld.Name.."-construction-robot"].normal.ingredients, Ingredient)
