...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Robot then	
	...
	DyWorld_Prototype_Entity.energy_usage = v.DyWorld.Entity.Roboport_Energy_Usage_KW.."kW"
	DyWorld_Prototype_Entity.charging_energy = v.DyWorld.Entity.Roboport_Charging_Energy_KW.."kW"
	DyWorld_Prototype_Entity.energy_source.input_flow_limit = v.DyWorld.Entity.Roboport_Input_MW.."MW"
	DyWorld_Prototype_Entity.energy_source.buffer_capacity = v.DyWorld.Entity.Roboport_Buffer_MJ.."MJ"
	DyWorld_Prototype_Entity.recharge_minimum = Round((v.DyWorld.Entity.Roboport_Buffer_MJ * 0.4), 0).."MJ"
	DyWorld_Prototype_Entity.logistics_radius = v.DyWorld.Entity.Roboport_Range_Logistic
	DyWorld_Prototype_Entity.construction_radius = v.DyWorld.Entity.Roboport_Range_Construction
	DyWorld_Prototype_Entity.robot_slots_count = v.DyWorld.Entity.Roboport_Slot_Count
	DyWorld_Prototype_Entity.material_slots_count = v.DyWorld.Entity.Roboport_Slot_Count
	...
	if v.DyWorld.Entity.Roboport_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Roboport_Ingredients) do
	...
	if v.DyWorld.Entity.Robot_Previous then
		local Ingredient = {type = "item", name = v.DyWorld.Entity.Robot_Previous.."-roboport", amount = 1}
		table.insert(data.raw.recipe[v.DyWorld.Name.."-roboport"].normal.ingredients, Ingredient)
	end
end
end