...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Belt then	
	...
	DyWorld_Prototype_Entity.next_upgrade = v.DyWorld.Entity.Belt.Belt_Next.."-underground-belt"
	DyWorld_Prototype_Entity.icon = nil
	DyWorld_Prototype_Entity.max_health = 150 * Metal_Tiers[v.DyWorld.Name]
	DyWorld_Prototype_Entity.max_distance = v.DyWorld.Entity.Belt.Belt_Range
	...
	DyWorld_Prototype_Recipe.normal.ingredients = {{type = "item", name = v.DyWorld.Name.."-transport-belt", amount = v.DyWorld.Entity.Belt.Belt_Range}}
	DyWorld_Prototype_Recipe.normal.results = {{type = "item", name = v.DyWorld.Name.."-underground-belt", amount = 2}}
	DyWorld_Prototype_Recipe.expensive.ingredients = {{type = "item", name = v.DyWorld.Name.."-transport-belt", amount = v.DyWorld.Entity.Belt.Belt_Range}}
	...
	if v.DyWorld.Entity.Belt.Belt_Previous then
		local Ingredient = {type = "item", name = v.DyWorld.Entity.Belt.Belt_Previous.."-underground-belt", amount = 2}
		table.insert(data.raw.recipe[v.DyWorld.Name.."-underground-belt"].normal.ingredients, Ingredient)
