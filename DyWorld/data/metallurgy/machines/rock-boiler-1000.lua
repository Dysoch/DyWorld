...
data:extend(
{
  {
    type = "boiler",
    name = dy.."rock-boiler-1000",
    icon = "__base__/graphics/icons/boiler.png",
	icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = dy.."rock-boiler-1000"},
    max_health = 2500,
    ...
    energy_consumption = tostring(500*0.5).."kW",
    energy_source =
    {
      type = "electric",
  ...
  },
  {
	...
	order = dy.."1000-rock-boiler",
	place_result = dy.."rock-boiler-1000",
	stack_size = 50,
  ...
  },
  {
	...
	{ 
	  ...
	  {"boiler", 1},
   	...
   	result = dy.."rock-boiler-1000",
  },
}
)

DyWorld_Add_To_Tech(dy.."ore-smelting", dy.."rock-boiler-1000")