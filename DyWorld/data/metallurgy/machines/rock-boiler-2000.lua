...
data:extend(
{
  {
    type = "boiler",
    name = dy.."rock-boiler-2000",
    icon = "__base__/graphics/icons/boiler.png",
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = dy.."rock-boiler-2000"},
    max_health = 2500,
    ...
    energy_consumption = tostring(2000*0.5).."kW",
    energy_source =
    {
      type = "electric",
  ...
  },
  {
	...
	order = dy.."2000-rock-boiler",
	place_result = dy.."rock-boiler-2000",
	stack_size = 50,
  ...
  },
  {
	...
	{ 
	  ...
	  {"boiler", 1},
   	...
   	result = dy.."rock-boiler-2000",
  },
}
)

DyWorld_Add_To_Tech(dy.."ore-smelting", dy.."rock-boiler-2000")