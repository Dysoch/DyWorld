...
data:extend(
{
  {
    type = "boiler",
    name = dy.."rock-boiler-3000",
    icon = "__base__/graphics/icons/boiler.png",
	icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = dy.."rock-boiler-3000"},
    max_health = 2500,
  ...
  },
  {
	...
	order = dy.."3000-rock-boiler",
	place_result = dy.."rock-boiler-3000",
	stack_size = 50,
  ...
  },
  {
	...
	{ 
	  ...
	  {"boiler", 1},
   	...
   	result = dy.."rock-boiler-3000",
  },
}
)

DyWorld_Add_To_Tech(dy.."ore-smelting", dy.."rock-boiler-3000")