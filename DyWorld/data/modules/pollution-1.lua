...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Pollution_1_Module then	
	...
	DyWorld_Prototype_Item.effect = {
      ...
      pollution = {bonus = v.DyWorld.Entity.Pollution_1_Module_Pollution_Boost},
	...
	if v.DyWorld.Entity.Pollution_1_Module_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Pollution_1_Module_Ingredients) do
