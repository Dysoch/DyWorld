...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Pollution_2_Module then	
	...
	DyWorld_Prototype_Item.effect = {
      consumption = {bonus = v.DyWorld.Entity.Pollution_2_Module.Pollution_2_Module_Consumption_Boost},
      pollution = {bonus = v.DyWorld.Entity.Pollution_2_Module.Pollution_2_Module_Pollution_Boost},
      --speed = {bonus = v.DyWorld.Entity.Pollution_2_Module.Pollution_1_Module_Speed_Boost}
    }
