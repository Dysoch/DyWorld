...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Productivity_Module then	
	...
	DyWorld_Prototype_Item.effect = {
      productivity = {bonus = v.DyWorld.Entity.Productivity_Module_Productivity_Boost},
      consumption = {bonus = v.DyWorld.Entity.Productivity_Module_Consumption_Boost},
      pollution = {bonus = v.DyWorld.Entity.Productivity_Module_Pollution_Boost},
      speed = {bonus = v.DyWorld.Entity.Productivity_Module_Speed_Boost}
    }
	...
	if v.DyWorld.Entity.Productivity_Module_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Productivity_Module_Ingredients) do
