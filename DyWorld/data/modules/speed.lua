...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Speed_Module then	
	...
	DyWorld_Prototype_Item.effect = {
      consumption = {bonus = v.DyWorld.Entity.Speed_Module_Consumption_Boost},
      pollution = {bonus = v.DyWorld.Entity.Speed_Module_Pollution_Boost},
      speed = {bonus = v.DyWorld.Entity.Speed_Module_Speed_Boost}
    }
	...
	if v.DyWorld.Entity.Speed_Module_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Speed_Module_Ingredients) do
