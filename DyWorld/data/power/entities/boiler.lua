...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Boiler then	
	...
	DyWorld_Prototype_Entity.target_temperature = v.DyWorld.Entity.Boiler_Max_Temp
	DyWorld_Prototype_Entity.energy_source.effectivity = v.DyWorld.Entity.Boiler_Effectivity
	DyWorld_Prototype_Entity.energy_source.emissions_per_minute = 20 + (10 * v.DyWorld.Tier)
	DyWorld_Prototype_Entity.icon = nil
	DyWorld_Prototype_Entity.energy_consumption = (v.DyWorld.Entity.Boiler_Energy_Consumption_KW).."kW"
	DyWorld_Prototype_Entity.fast_replaceable_group = "boiler"
	DyWorld_Prototype_Entity.next_upgrade = v.DyWorld.Entity.Boiler_Next.."-boiler"
	...
	if v.DyWorld.Entity.Boiler_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Boiler_Ingredients) do
	...
	if v.DyWorld.Entity.Boiler_Previous then
		local Ingredient = {type = "item", name = v.DyWorld.Entity.Boiler_Previous.."-boiler", amount = 1}
		table.insert(data.raw.recipe[v.DyWorld.Name.."-boiler"].normal.ingredients, Ingredient)
	end
end
end