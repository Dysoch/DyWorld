...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Nuclear_Reactor then	
	...
	DyWorld_Prototype_Entity.heat_buffer.max_temperature = v.DyWorld.Entity.Nuclear_Reactor_Max_Temperature
	DyWorld_Prototype_Entity.heat_buffer.specific_heat = v.DyWorld.Entity.Nuclear_Reactor_Specific_Heat_MJ.."MJ"
	DyWorld_Prototype_Entity.heat_buffer.max_transfer = v.DyWorld.Entity.Nuclear_Reactor_Max_Transfer_GW.."GW"
	DyWorld_Prototype_Entity.consumption = v.DyWorld.Entity.Nuclear_Reactor_Consumption_MW.."MW"
	DyWorld_Prototype_Entity.neighbour_bonus = v.DyWorld.Entity.Nuclear_Reactor_Neighbour_Bonus
	DyWorld_Prototype_Entity.energy_source.effectivity = v.DyWorld.Entity.Nuclear_Reactor_Effectivity
	DyWorld_Prototype_Entity.fast_replaceable_group = "nuclear-reactor"
	DyWorld_Prototype_Entity.next_upgrade = v.DyWorld.Entity.Nuclear_Reactor_Next.."-nuclear-reactor"
	...
	if v.DyWorld.Entity.Nuclear_Reactor_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Nuclear_Reactor_Ingredients) do
	...
	if v.DyWorld.Entity.Nuclear_Reactor_Previous then
		local Ingredient = {type = "item", name = v.DyWorld.Entity.Nuclear_Reactor_Previous.."-nuclear-reactor", amount = 1}
		table.insert(data.raw.recipe[v.DyWorld.Name.."-nuclear-reactor"].normal.ingredients, Ingredient)
	end
end
end