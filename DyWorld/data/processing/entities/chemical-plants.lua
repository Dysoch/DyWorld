...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Chemical then	
	...
	if v.DyWorld.Entity.Chemical.Next then
		DyWorld_Prototype_Entity.next_upgrade = v.DyWorld.Entity.Chemical.Next.."-chemical-plant"
	end
	DyWorld_Prototype_Entity.crafting_speed = Round(((0.5 * (v.DyWorld.Tier * (v.DyWorld.Tier * 0.5))) * v.DyWorld.Entity.Chemical.Speed_Mod), 2)
	DyWorld_Prototype_Entity.energy_usage = Round(750 + (Round(((0.5 * (v.DyWorld.Tier * (v.DyWorld.Tier * 0.5))) * v.DyWorld.Entity.Chemical.Speed_Mod), 2) * 50)).."kW"
	...
	if v.DyWorld.Entity.Chemical.Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Chemical.Ingredients) do
	...
	if v.DyWorld.Entity.Chemical.Previous then
		local Ingredient = {type = "item", name = v.DyWorld.Entity.Chemical.Previous.."-chemical-plant", amount = 1}
		table.insert(data.raw.recipe[v.DyWorld.Name.."-chemical-plant"].normal.ingredients, Ingredient)
