...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Furnace then	
	...
	DyWorld_Prototype_Entity.next_upgrade = v.DyWorld.Entity.Furnace_Next.."-electric-furnace"
	DyWorld_Prototype_Entity.crafting_speed = Round(((0.5 * (v.DyWorld.Tier * (v.DyWorld.Tier * 0.5))) * v.DyWorld.Entity.Furnace_Speed_Mod), 2)
	...
	if v.DyWorld.Entity.Furnace_Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Furnace_Ingredients) do
