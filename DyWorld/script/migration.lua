...
function Migrate_To_Next_Version()
	...
	if global.dyworld.Version == "0.9.2" or global.dyworld.Version == "0.9.3" or global.dyworld.Version == "0.9.4" or global.dyworld.Version == "0.9.5" or global.dyworld.Version == "0.9.6" or global.dyworld.Version == "0.9.7" then
		-- This part below is done every migration!
		global.dyworld.Max_Research = Research_Calc(),
		global.dyworld.Research_Done == 0
		global.stats.research = 0
