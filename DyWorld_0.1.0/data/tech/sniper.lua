...
function DyWorld_Sniper_Damage(Level, Pack1, Pack2, Pack3, Count, Time)
  local result =
  {
    type = "technology",
...
function DyWorld_Sniper_Speed(Level, Pack1, Pack2, Pack3, Count, Time)
  local result =
  {
    type = "technology",
...
for i=1,10 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 0, 0, (i*50), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 0, 0, (i*50), (i*2)),
})
end
...
for i=11,30 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 1, 0, (i*100), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 1, 0, (i*100), (i*2)),
})
end
...
for i=31,60 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 1, 1, (i*200), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 1, 1, (i*200), (i*2)),
})
end
...
for i=61,100 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 1, 1, (i*500), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 1, 1, (i*500), (i*2)),
})
end
...
for i=101,500 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 1, 1, (i*1000), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 1, 1, (i*1000), (i*2)),
})
end