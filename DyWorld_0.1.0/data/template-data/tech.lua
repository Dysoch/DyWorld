...
Data_Table_Tech = {
	...
	{
		Name = dyworld_prefix.."tech-"..primitive.."-turret-1",
		Icon = data.raw["mining-tool"]["iron-axe"].icon,
		Count = 25,
		Time = 5,
		PreReq = true,
	...
	{
		Name = dyworld_prefix.."tech-"..primitive.."-turret-2",
		Icon = data.raw["mining-tool"]["iron-axe"].icon,
		Count = 50,
		Time = 5,
		PreReq = true,
		PreReq_Tech = {dyworld_prefix.."tech-"..primitive.."-turret-1"},
		Effects = true,
	...
	{
		Name = dyworld_prefix.."tech-"..primitive.."-turret-3",
		Icon = data.raw["mining-tool"]["iron-axe"].icon,
		Count = 100,
		Time = 5,
		PreReq = true,
		PreReq_Tech = {dyworld_prefix.."tech-"..primitive.."-turret-2", "steel-processing"},
		Effects = true,
