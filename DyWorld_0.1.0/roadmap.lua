...
function Roadmap()
	global.Roadmap = 
	{
		...
		Ammo_Primitive = {Progress = 100, Name = "Ammo Primitive"},
		Weapons_Primitive = {Progress = 0, Name = "Weapons Primitive"},
		Turrets_Primitive = {Progress = 80, Name = "Turrets Primitive"},
		Armor_Primitive = {Progress = 75, Name = "Armor Primitive"},
		Machines_Primitive = {Progress = 75, Name = "Machines Primitive"},
		Tools_Primitive = {Progress = 100, Name = "Tools Primitive"},
		Techs_Primitive = {Progress = 50, Name = "Technology Primitive"},
