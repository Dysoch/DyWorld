...
function Roadmap()
	global.Roadmap = 
	{
		GUI = {Progress = 50, Name = "GUI"},
		Story = {Progress = 15, Name = "Story"},
		Forum = {Progress = 30, Name = "Forum"},
		Groundwork = {Progress = 50, Name = "Groundwork"},
		Formula = {Progress = 100, Name = "Formula"},
		Locales = {Progress = 25, Name = "Locales"},
		Multiplayer = {Progress = 50, Name = "Multiplayer"},
		Base_Edit = {Progress = 50, Name = "Base Edits"},
		Primitive = {Progress = 70, Name = "Primitive Stage"},
		...
		Weapons_Primitive = {Progress = 0, Name = "Primitive Stage: Weapons"},
		Turrets_Primitive = {Progress = 80, Name = "Primitive Stage: Turrets"},
		Armor_Primitive = {Progress = 75, Name = "Primitive Stage: Armor"},
		Machines_Primitive = {Progress = 75, Name = "Primitive Stage: Machines"},
		Miners_Primitive = {Progress = 100, Name = "Primitive Stage: Miners"},
		Tools_Primitive = {Progress = 100, Name = "Primitive Stage: Tools"},
		Techs_Primitive = {Progress = 50, Name = "Primitive Stage: Technology"},
