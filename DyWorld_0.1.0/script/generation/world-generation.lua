...
function Ship_Spawner(event)
	...
	Ship_1_Pos = game.surfaces[1].find_non_colliding_position(BuildEntity1, {PosX,PosY}, 100, 100)
	Ship_2_Pos = game.surfaces[1].find_non_colliding_position(BuildEntity2, {PosX,PosY}, 100, 100)
	Ship_3_Pos = game.surfaces[1].find_non_colliding_position(BuildEntity3, {PosX,PosY}, 100, 100)
	if game.surfaces[1].can_place_entity{name=(BuildEntity1), position=Ship_1_Pos} and not global.dyworld.Generation_Ship_1 then 
	...
	if game.surfaces[1].can_place_entity{name=(BuildEntity2), position=Ship_2_Pos} and not global.dyworld.Generation_Ship_2 then 
	...
	if game.surfaces[1].can_place_entity{name=(BuildEntity3), position=Ship_3_Pos} and not global.dyworld.Generation_Ship_3 then 
