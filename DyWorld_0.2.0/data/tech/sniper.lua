...
for i=11,30 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 1, 0, 1, (i*50), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 1, 0, 1, (i*50), (i*2)),
})
end
...
for i=31,60 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 1, 1, 2, (i*50), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 1, 1, 2, (i*50), (i*2)),
})
end
...
for i=61,100 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 1, 1, 5, (i*50), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 1, 1, 5, (i*50), (i*2)),
})
end
...
for i=101,500 do
 data:extend(
{
  DyWorld_Sniper_Damage(i, 1, 1, 1, 10, (i*50), (i*1)),
  DyWorld_Sniper_Speed(i, 1, 1, 1, 10, (i*50), (i*2)),
})
end