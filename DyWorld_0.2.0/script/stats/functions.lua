...
function BodySkills(id)
	...
	game.players[id].character_mining_speed_modifier = ((((p1*25)+(p2*15)+gsm)/5000)-0.258) -- or -0.008
	game.players[id].character_crafting_speed_modifier = ((((p4*25)+(p3*15)+gsc)/5000)-0.008) -- or -0.008
