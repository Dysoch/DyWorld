...
Data_Table_Laser_Turret = {
	...
	{
		Name = dyworld_prefix.."turret-laser-basic-03",
		Health = 2250,
		Tint = {r=0.500, g=0.500, b=0.500},
		Attack_Speed = (60/5),
		Ammo_Cat = "laser",
		...
		Turn_Max_Range = 360,
		Energy = 24,
		Projectile = dyworld_prefix.."projectile-laser-04",
		Projectile_Speed = 0.5,
		Stack = 100,
		Recipe_Craft_Time = 20,
		Result_Count = 1,
		Recipe_Without_Tech = false,
		Recipe_Ingredients = {{dyworld_prefix.."turret-laser-basic-01",1},{"steel-plate",25},{"advanced-circuit",20},{"battery",5}},
		Resistance = true,
		Resistance_Ingredients = {{type = "physical", decrease = 10, percent = 15 },{type = "acid", decrease = 10, percent = 15},{type = "explosion", decrease = 50, percent = 50},{type = "fire", decrease = 10, percent = 50},{type = "laser", decrease = 100, percent = 99}},
	},
	{
		Name = dyworld_prefix.."turret-laser-basic-04",
		Health = 4500,
		Tint = {r=0.500, g=0.500, b=0.500},
		Attack_Speed = (60/6),
		Ammo_Cat = "laser",
		...
		Turn_Max_Range = 360,
		Energy = 25,
		Projectile = dyworld_prefix.."projectile-laser-05",
		Projectile_Speed = 0.5,
		Stack = 100,
		Recipe_Craft_Time = 20,
		Result_Count = 1,
		Recipe_Without_Tech = false,
		Recipe_Ingredients = {{dyworld_prefix.."turret-laser-basic-02",1},{"steel-plate",15},{"advanced-circuit",15},{"battery",4}},
		Resistance = true,
		Resistance_Ingredients = {{type = "physical", decrease = 10, percent = 15 },{type = "acid", decrease = 10, percent = 15},{type = "explosion", decrease = 50, percent = 50},{type = "fire", decrease = 10, percent = 50},{type = "laser", decrease = 100, percent = 99}},
	},
	{
		Name = dyworld_prefix.."turret-laser-sniper-02",
		Health = 7500,
		Tint = {r=0.500, g=0.500, b=0.500},
		Attack_Speed = (60/2),
		Ammo_Cat = "laser",
		...
		Turn_Max_Range = 360,
		Energy = 150,
		Projectile = dyworld_prefix.."projectile-laser-06",
		Projectile_Speed = 5,
		Stack = 100,
		Recipe_Craft_Time = 25,
		Result_Count = 1,
		Recipe_Without_Tech = false,
		Recipe_Ingredients = {{dyworld_prefix.."turret-laser-sniper-01",1},{"steel-plate",25},{"advanced-circuit",35},{"battery",25}},
		Resistance = true,
		Resistance_Ingredients = {{type = "physical", decrease = 10, percent = 15 },{type = "acid", decrease = 10, percent = 15},{type = "explosion", decrease = 50, percent = 50},{type = "fire", decrease = 10, percent = 50},{type = "laser", decrease = 100, percent = 99}},
	},
}
