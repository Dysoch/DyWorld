...
Data_Table_Inserter_Fast = {
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{"fast-inserter", 1},{"electronic-circuit", 25}},
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."inserter-fast-1", 1},{"advanced-circuit", 25}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 100,
		Health = 1000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."inserter-fast-2", 1},{"advanced-circuit", 50}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 100,
		Health = 2500,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."inserter-fast-3", 1},{"processing-unit", 100}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 100,
		Health = 10000,
