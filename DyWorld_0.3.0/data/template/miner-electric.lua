...
Data_Table_Miner_Electric = {
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{"electric-mining-drill", 2}},
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-1", 2}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 5000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 10,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-2", 2}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 5000,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-3", 2}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 15000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 30,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-4", 2}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 15000,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-5", 2}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 100000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 60,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-6", 2}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 100000,
