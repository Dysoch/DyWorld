...
Data_Table_Miner_Electric = {
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{"electric-mining-drill", 1}},
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-1", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 1000,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-2", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 5000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 10,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-3", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 5000,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-4", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 15000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 30,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-5", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 15000,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-6", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 100000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 60,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-7", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 100000,
