...
Data_Table_Tools = {
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 2,
		Recipe_Ingredients = {{"stone", 3},{dyworld_prefix_intermediate.."stone-stick", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = true,
		Stack = 50,
		Durability = 2500,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 4,
		Recipe_Ingredients = {{dyworld_prefix.."tool-02", 1},{"copper-plate",3},{dyworld_prefix_intermediate.."binding-copper", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = true,
		Stack = 50,
		Durability = 3500,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."tool-03", 1},{"iron-plate",5},{dyworld_prefix_intermediate.."binding-iron", 1}},
		Recipe_Results_Count = 1,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 8,
		Recipe_Ingredients = {{dyworld_prefix.."tool-04", 1},{"steel-plate",5},{dyworld_prefix_intermediate.."steel-stick", 1},{dyworld_prefix_intermediate.."binding-steel", 1}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Durability = 10000,
