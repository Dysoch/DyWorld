...
Data_Table_Transport_Splitter = {
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 1,
		Recipe_Ingredients = {{dyworld_prefix.."transport-belt-01", 4},{dyworld_prefix_intermediate.."stone-gear", 5},{dyworld_prefix_intermediate.."binding-iron", 2}},
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 1,
		Recipe_Ingredients = {{dyworld_prefix.."transport-belt-02", 4},{"processing-unit", 5}},
		Recipe_Results_Count = 4,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 1,
		Recipe_Ingredients = {{dyworld_prefix.."transport-belt-03", 4},{dyworld_prefix_intermediate.."processing-advanced", 5}},
		Recipe_Results_Count = 4,
		Recipe_Without_Tech = false,
		Stack = 200,
		Health = 1000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 1,
		Recipe_Ingredients = {{dyworld_prefix.."transport-belt-04", 4},{dyworld_prefix_intermediate.."processing-logic", 5}},
		Recipe_Results_Count = 4,
		Recipe_Without_Tech = false,
		Stack = 200,
		Health = 2500,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 1,
		Recipe_Ingredients = {{dyworld_prefix.."transport-belt-05", 4},{dyworld_prefix_intermediate.."processing-logic", 10},{dyworld_prefix_intermediate.."crystal", 5}},
		Recipe_Results_Count = 4,
		Recipe_Without_Tech = false,
		Stack = 200,
		Health = 10000,
