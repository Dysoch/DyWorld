...
Data_Table_Inserter_Long = {
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{"long-handed-inserter", 1},{"advanced-circuit", 25}},
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."inserter-long-1", 1},{"processing-unit", 25},{dyworld_prefix_intermediate.."steel-gear", 5}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 100,
		Health = 1000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."inserter-long-2", 1},{dyworld_prefix_intermediate.."processing-advanced", 50},{dyworld_prefix_intermediate.."steel-stick", 10}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 100,
		Health = 2500,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."inserter-long-3", 1},{dyworld_prefix_intermediate.."processing-logic", 100},{dyworld_prefix_intermediate.."crystal", 5}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 100,
		Health = 10000,
