...
Data_Table_Locomotive = {
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{"locomotive", 1},{"advanced-circuit", 25},{dyworld_prefix_intermediate.."steel-gear", 15}},
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."locomotive-1", 1},{"processing-unit", 25},{dyworld_prefix_intermediate.."steel-stick", 150}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 5,
		Health = 5000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."locomotive-2", 1},{dyworld_prefix_intermediate.."processing-advanced", 25},{dyworld_prefix_intermediate.."binding-steel", 15}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 5,
		Health = 15000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{dyworld_prefix.."locomotive-3", 1},{dyworld_prefix_intermediate.."processing-logic", 25},{dyworld_prefix_intermediate.."crystal", 15}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 5,
		Health = 75000,
