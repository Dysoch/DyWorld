...
Data_Table_Miner_Electric = {
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{"electric-mining-drill", 2},{dyworld_prefix_intermediate.."gearbox", 2},{dyworld_prefix_intermediate.."rotor", 5},{dyworld_prefix_intermediate.."binding-iron", 50},{"advanced-circuit", 5}},
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{"electric-mining-drill", 2},{dyworld_prefix_intermediate.."gearbox", 5},{dyworld_prefix_intermediate.."rotor", 2},{dyworld_prefix_intermediate.."binding-iron", 75},{"advanced-circuit", 8}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 1000,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-1", 2},{dyworld_prefix_intermediate.."gearbox", 6},{dyworld_prefix_intermediate.."rotor", 12},{dyworld_prefix_intermediate.."binding-steel", 50},{"processing-unit", 5}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 5000,
	...
	},
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 10,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-2", 2},{dyworld_prefix_intermediate.."gearbox", 12},{dyworld_prefix_intermediate.."rotor", 6},{dyworld_prefix_intermediate.."binding-steel", 75},{"processing-unit", 8}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 5000,
	...
	{
		Name = dyworld_prefix.."drill-electric-5",
		--Icon = --todo
		Recipe_Craft_Time = 30,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-3", 2},{dyworld_prefix_intermediate.."gearbox", 20},{dyworld_prefix_intermediate.."rotor", 40},{dyworld_prefix_intermediate.."processing-advanced", 18}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 15000,
	...
	{
		Name = dyworld_prefix.."drill-electric-6",
		--Icon = --todo
		Recipe_Craft_Time = 30,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-4", 2},{dyworld_prefix_intermediate.."gearbox", 40},{dyworld_prefix_intermediate.."rotor", 20},{dyworld_prefix_intermediate.."processing-advanced", 25}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 15000,
	...
	{
		Name = dyworld_prefix.."drill-electric-7",
		--Icon = --todo
		Recipe_Craft_Time = 60,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-5", 2},{dyworld_prefix_intermediate.."crystal", 20},{dyworld_prefix_intermediate.."processing-logic", 30}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 100000,
	...
	{
		Name = dyworld_prefix.."drill-electric-8",
		--Icon = --todo
		Recipe_Craft_Time = 60,
		Recipe_Ingredients = {{dyworld_prefix.."drill-electric-6", 2},{dyworld_prefix_intermediate.."crystal", 20},{dyworld_prefix_intermediate.."processing-logic", 45}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 100000,
...
function DyWorld_Miner_Electric_Item(NAME, STACK)
  local result =
  {
    ...
    subgroup = dyworld_prefix.."extraction-electric",
    order = NAME,
    place_result = NAME,
    stack_size = STACK,
  }
...
data:extend(
	{
		...
		DyWorld_Miner_Electric_Recipe(v.Name, v.Recipe_Craft_Time, v.Recipe_Results_Count, v.Recipe_Without_Tech),
	})
