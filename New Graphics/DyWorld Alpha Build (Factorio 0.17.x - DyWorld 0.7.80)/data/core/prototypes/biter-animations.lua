...
function DyWorld_biterrunanimation(scale, tint1, tint2)
  return
  {
    layers=
    {
...
function DyWorld_biterattackanimation(scale, tint1, tint2)
  return
  {
    layers=
    {
...
function DyWorld_biterdieanimation(scale, tint1, tint2)
  return
  {
    layers=
    {
