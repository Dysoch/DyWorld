...
if v.DyWorld and v.DyWorld.Entity and v.DyWorld.Entity.Pollution_2_Module then	
	...
	DyWorld_Prototype_Item.effect = {
      consumption = {bonus = v.DyWorld.Entity.Pollution_2_Module.Consumption_Boost},
      pollution = {bonus = v.DyWorld.Entity.Pollution_2_Module.Pollution_Boost},
      --speed = {bonus = v.DyWorld.Entity.Pollution_2_Module.Speed_Boost}
    }
	...
	if v.DyWorld.Entity.Pollution_2_Module.Ingredients then
		for q,a in pairs(v.DyWorld.Entity.Pollution_2_Module.Ingredients) do
