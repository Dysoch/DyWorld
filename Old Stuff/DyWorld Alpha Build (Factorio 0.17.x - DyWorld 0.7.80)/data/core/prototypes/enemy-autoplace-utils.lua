function DyWorld_enemy_autoplace(distance, order, is_turret)
...
function DyWorld_enemy_spawner_autoplace(distance)
  return DyWorld_enemy_autoplace(distance, "b[enemy]-a[spawner]", false)
end

function DyWorld_enemy_worm_autoplace(distance)
  return DyWorld_enemy_autoplace(distance, "b[enemy]-b[worm]", true)
end
