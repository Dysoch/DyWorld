...
{
  {
    type = "furnace",
    name = "forge-gear-"..i,
	localised_name = {"looped-name.forge-gear", i},
    icons = 
	{
	  {
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "forge-gear-"..i},
    ...
    crafting_categories = {dy.."forging-gear"},
  ...
  },
  {
	...
	local Insert_Recipe = {type = "item", name = "forge-gear-"..(i-1), amount = 1}
	if i >= 2 then 
