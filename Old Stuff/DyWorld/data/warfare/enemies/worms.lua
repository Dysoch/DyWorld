...
{
  {
    ...
    dying_sound = Dy_sounds_worm_dying(1),
    ...
    preparing_sound = Dy_sounds_worm_standup(1),
    prepared_sound = Dy_sounds_worm_breath(0.8),
    ...
    prepared_alternative_sound = Dy_sounds_worm_roar_alternative(0.7),
    ...
    starting_attack_sound = Dy_sounds_worm_roars(0.7),
    ...
    folding_sound = Dy_sounds_worm_fold(1),
