...
require("data.template.intermediates")
...
require("data.template.locomotive")
require("data.template.transport-belt")
require("data.template.transport-splitter")
require("data.template.transport-underground")
require("data.template.furnace-burner")
require("data.template.furnace-electric")
require("data.template.assembling-burner")
require("data.template.assembling-electric")
