...
Data_Table_Radar = {
	{
		...
		--Icon = --todo
		Recipe_Craft_Time = 5,
		Recipe_Ingredients = {{"raw-wood", 1},{"electronic-circuit", 5},{"iron-plate", 15},{dyworld_prefix_intermediate.."stone-gear", 5}},
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."radar-basic", 1},{"advanced-circuit", 15},{"iron-plate", 25},{"iron-gear-wheel", 25}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 2500,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."radar-intermediate", 1},{"processing-unit", 150},{"steel-plate", 25},{dyworld_prefix_intermediate.."steel-gear", 25}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 10000,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."radar-enhanced", 1},{dyworld_prefix_intermediate.."processing-advanced", 15},{"steel-plate", 75}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 50000,
	...
	},
	{
		...
		Recipe_Ingredients = {{dyworld_prefix.."radar-advanced", 2},{dyworld_prefix_intermediate.."processing-logic", 150},{dyworld_prefix_intermediate.."solar-cell", 150},{"steel-plate", 300},{dyworld_prefix_intermediate.."steel-stick", 200}},
		Recipe_Results_Count = 1,
		Recipe_Without_Tech = false,
		Stack = 50,
		Health = 250000,
